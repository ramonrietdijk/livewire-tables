...
>
    @include('livewire-table::modals.modals')

    <div class="bg-white dark:bg-gray-800 rounded-md shadow-sm flex flex-col border border-gray-300 dark:border-gray-600 transition">
